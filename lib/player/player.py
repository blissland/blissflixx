...
class _Player(object):
	...
	def stop(self):
		...
		if state == ST_TARGET_STARTING or state == ST_RUNNING:
			print ("DOING TARGET STOP")
			self.target.stop()
		elif state == ST_SOURCE_STARTING:
			print ("DOING SOURCE STOP")
			self.source.stop()
